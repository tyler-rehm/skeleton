...
@section('css')
    <style>
        /*
         *  Page-specific Custom CSS Styles
        */
    </style>
@endsection
...
@section('content')
        ...
        <div class="row"> <!-- padded sub dashboard panels -->
            <div class="col-lg-12">
...
@section('js')
    <script>
        /*
         *  Page-specific Custom Js Scripts
         */
        $(document).ready(function() {      // page load welcome growl notification
            setTimeout(function() {
                toastr.options = {
                    closeButton: true,
                    progressBar: true,
                ...
                toastr.success('Your communication platform', 'Welcome to {{ config('app.name') }}');
